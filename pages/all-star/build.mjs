...
const PAGES = [
  { key: 'hub',   url: '/all-star-fight-by-buakaw',            out: 'all-star-HUB-PASTE-INTO-TILDA.html' },
  { key: 'dated', url: '/all-star-fight-by-buakaw/2026-09-28', out: 'all-star-28-SEP-PASTE-INTO-TILDA.html' },
];
