...
const PAGES = [
  { key: 'hub',   url: '/petchyindee-muay-thai',            out: 'petchyindee-HUB-PASTE-INTO-TILDA.html' },
  { key: 'dated', url: '/petchyindee-muay-thai/2026-10-01', out: 'petchyindee-01-OCT-PASTE-INTO-TILDA.html' },
];
