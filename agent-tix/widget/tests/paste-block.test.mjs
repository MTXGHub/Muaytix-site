// Agent Tix — the paste-in block, on a page built like a Tilda page
//
//   node agent-tix/widget/tests/paste-block.test.mjs
//
// Drives the exact block handed over for pasting, inside Tilda's wrapper and
// stylesheet, all the way to the Stripe handover.
...
const block=fs.readFileSync(new URL('../paste-into-tilda.html',import.meta.url),'utf8');
let pass=0,fail=0;
